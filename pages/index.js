      ...
      <div className="landing_container">
          ...
          <div className="offer_blocks">
            <div className="offer_block">
              ...
              <p className="offer_text_sub">
                ...
                assets they have pledged to the blockchain, ensuring that
            ...
            <div className="offer_block">
              ...
              <p className="offer_text_main">Fast</p>
              <p className="offer_text_sub">
                Algorand’s consensus protocol works by selecting a block
                proposer and a set of voting committees at each block round, to
                propose a block and validate.
              </p>
            </div>
            <div className="offer_block">
              <div className="offer_icon">
        ...
        <div className="api_preview">
          <p className="section_header">
            Let’s help make asset collection easy.
          </p>
          ...
          <div className="section_content">
            <div className="section_text">
              ...
              <p className="sub">
                ...
                first hills of the Italic Mountains.
              </p>
            </div>
