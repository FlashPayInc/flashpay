          ...
          <div className="api_preview">
            ...
            <div className="section_content">
              <div className="section_text">
                <p className="main">FlashPay API</p>
                <div className="sub">
                  Generate payment links, view transactions with our APIs
                </div>
                <p className="main second_child">FlashPay Javascript SDK</p>
                <p className="sub">Integrate our SDK in your applications.</p>
              </div>
